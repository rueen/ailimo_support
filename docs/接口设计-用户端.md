...
### 2.5 获取设备租赁提前预约天数
**接口地址**: `GET /api/h5/equipment-advance-days`
...
### 2.6 提交设备租赁订单
**接口地址**: `POST /api/h5/equipment-reservations`
...
### 3.3 获取笼位租赁提前预约天数
**接口地址**: `GET /api/h5/cage-advance-days`
...
### 3.4 提交笼位租赁订单
**接口地址**: `POST /api/h5/cage-reservations`
...
### 4.2 获取实验代操作提前预约天数
**接口地址**: `GET /api/h5/experiment-advance-days`
...
### 4.3 提交实验代操作订单
**接口地址**: `POST /api/h5/experiment-operations`
