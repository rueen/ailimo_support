...
### 1.5 审核通过实验代操作订单
**接口地址**: `PUT /api/support/experiment-operations/:id/approve`
...
**权限要求**: `experiment_operation:approve`

---

### 1.6 审核拒绝实验代操作订单
**接口地址**: `PUT /api/support/experiment-operations/:id/reject`

**请求参数**:
```json
{
  "rejectReason": "该时间段人员不足"  // 必填，拒绝原因
}
```
...
**权限要求**: `experiment_operation:reject`
...
### 3.7 获取提前预约天数配置
**接口地址**: `GET /api/support/experiment-advance-days`
...
**权限要求**: `experiment_advance_days:view`

---

### 3.8 更新提前预约天数配置
**接口地址**: `PUT /api/support/experiment-advance-days`
...
2. 更新system_configs表中的experiment_advance_days配置

**权限要求**: `experiment_advance_days:update`
