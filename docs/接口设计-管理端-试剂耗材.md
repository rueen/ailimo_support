...
### 1.5 审核通过试剂耗材订购订单
**接口地址**: `PUT /api/support/reagent-orders/:id/approve`
...
**权限要求**: `reagent_order:approve`

---

### 1.6 审核拒绝试剂耗材订购订单
**接口地址**: `PUT /api/support/reagent-orders/:id/reject`

**请求参数**:
```json
{
  "rejectReason": "该试剂暂时缺货"  // 必填，拒绝原因
}
```
