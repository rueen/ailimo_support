...
### 1.5 审核通过动物订购订单
**接口地址**: `PUT /api/support/animal-orders/:id/approve`
...
**权限要求**: `animal_order:approve`

---

### 1.6 审核拒绝动物订购订单
**接口地址**: `PUT /api/support/animal-orders/:id/reject`

**请求参数**:
```json
{
  "rejectReason": "该品系暂时缺货"  // 必填，拒绝原因
}
```
