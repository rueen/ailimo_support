<template>
  <div class="experiment-time-slot-container">
    <div class="action-bar">
      <a-button
        v-if="userStore.hasPermission('experiment_time_slot:create')"
        type="primary"
        @click="handleAdd"
      >
        <PlusOutlined />
    ...
    >
      <template #bodyCell="{ column, record }">
        ...
        <template v-else-if="column.key === 'action'">
          <a-space>
            <a-button
              v-if="userStore.hasPermission('experiment_time_slot:update')"
              type="link"
              size="small"
            ...
            <a-popconfirm
              v-if="userStore.hasPermission('experiment_time_slot:delete')"
              title="确定删除该时间段吗？"
